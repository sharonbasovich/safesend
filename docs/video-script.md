...
| 2:30–2:45 | Slide: limitations | "No owner, no fees, no upgradeability, checks-effects-interactions, fifty-six tests including fuzz and invariants at full line coverage. Honest limits: it only guards sends through the router, fingerprints only cover the first and last four characters, and it's an unaudited prototype. But the most common way people lose money to poisoning just became a cancellable escrow. SafeSend." |
